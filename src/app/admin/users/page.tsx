      ...
      <div className="card-brutal bg-white dark:bg-zinc-900 overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            <Users size={32} className="text-zinc-300 dark:text-zinc-600 mx-auto mb-2" />
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-3 border-brand-black dark:border-white bg-zinc-50 dark:bg-zinc-800">
                  {["#", "Username", "Email", "Bergabung"].map((h) => (
                    <th
                      key={h}
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 bg-brand-orange border-2 border-brand-black flex items-center justify-center">
